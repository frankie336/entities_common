...
The **EntitiesCommon** SDK provides a programmatic interface to the  [EntitiesCommon AI API](https://github.com/frankie336/entities_api). 
...
EntitiesCommon API aggregates the core features and methodologies of all providers into one unified platform.
...
The EntitiesCommon API [Threads](/docs/threads.md)  endpoint simplifies dialogue management by providing a standardized, data-driven setup and use procedure. Data storage and retrieval are handled by this endpoint.
...
from entities import EntitiesCommon
