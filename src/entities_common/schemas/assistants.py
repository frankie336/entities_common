...
class AssistantCreate(BaseModel):
    ...
    response_format: str = Field("auto", description="Format of the assistant's response", example="auto")


class AssistantRead(BaseModel):
    id: str = Field(..., description="Unique identifier for the assistant")
    user_id: Optional[str] = Field(None, description="Identifier for the user associated with the assistant")
    ...
    tools: Optional[List[dict]] = Field(None, description="List of tool definitions associated with the assistant")
    meta_data: Optional[Dict[str, Any]] = Field(None, description="Additional metadata for the assistant")
    ...
    vector_stores: Optional[List[VectorStoreRead]] = Field(default_factory=list, description="List of associated vector stores")
...
class AssistantUpdate(BaseModel):
    ...
    meta_data: Optional[Dict[str, Any]] = Field(None, description="Updated metadata for the assistant")
